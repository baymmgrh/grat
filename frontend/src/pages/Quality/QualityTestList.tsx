...
import { useGetQualityDashboardQuery, useGetQualityAlertsQuery, useAcknowledgeQualityAlertMutation } from '../../services/api';
...
export default function QualityTestList() {
  const { data: dashboardData, isLoading, error, refetch } = useGetQualityDashboardQuery({});
  const { data: alertsData } = useGetQualityAlertsQuery({ status: 'active' });
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Unable to load quality dashboard data</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/app/quality/tests/new" className="btn-primary inline-flex items-center gap-2">
